...
public class Auction {
    ...
    private static final List<String> categoryList = new ArrayList<>(Arrays.asList("elektronika", "moda", "dom", "supermarket", "dziecko","uroda", "zdrowie","kultura", "sport", "motoryzacja", "sztuka"));
    ...
    public Auction(int auctionID, String title, String description, double price, Date startDate, Date endDate, int numberOfPhotos, String category, User user) {
        this.auctionID = auctionID;
        this.title = title;
        this.description = description;
        this.price = price;
